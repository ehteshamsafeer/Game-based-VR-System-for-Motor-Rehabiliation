...
public class snd_recv2 : MonoBehaviour
{
    ...
    void SendMessageToServer(string message)
    {
        if (stream.CanWrite)
        {
            ...
            stream.WriteByte(0x02);  // Message type for strings
            byte[] messageSize = BitConverter.GetBytes(IPAddress.HostToNetworkOrder(messageData.Length));
